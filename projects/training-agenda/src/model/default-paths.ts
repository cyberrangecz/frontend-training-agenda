...
export const RUN_PATH = 'training-run';
...
export const LINEAR_TRAINING_RUN_ACCESS_PATH = 'access-linear';
export const COOP_TRAINING_RUN_ACCESS_PATH = 'access-coop';
export const TRAINING_RUN_ACCESS_SELECTOR = 'access-token';
export const LINEAR_TRAINING_RUN_RESUME_PATH = 'resume-linear';
export const COOP_TRAINING_RUN_RESUME_PATH = 'resume-coop';
