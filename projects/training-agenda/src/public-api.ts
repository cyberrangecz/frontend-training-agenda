/*
 * Public API Surface of training-agenda
 */
...
export * from './lib/services/resolvers/training-definition-breadcrumb-resolver.service';
export * from './lib/services/resolvers/training-definition-resolver.service';
export * from './lib/services/resolvers/training-instance-breadcrumb-resolver.service';
export * from './lib/services/resolvers/training-instance-detail-breadcrumb-resolver.service';
export * from './lib/services/resolvers/training-instance-resolver.service';
