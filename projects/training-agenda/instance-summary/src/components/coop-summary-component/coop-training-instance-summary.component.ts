 ...
 */
@Component({
    selector: 'crczp-coop-training-instance-summary',
    templateUrl: './coop-training-instance-summary.component.html',
    styleUrls: ['./coop-training-instance-summary.component.css'],
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class CoopTrainingInstanceSummaryComponent implements OnInit {
