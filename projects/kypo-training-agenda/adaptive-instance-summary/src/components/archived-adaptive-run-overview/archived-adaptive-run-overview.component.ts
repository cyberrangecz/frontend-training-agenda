...
/**
 * Component for displaying archived (finished by trainee and with sandbox removed) adaptive runs for organizer in real-time.
 */
@Component({
  selector: 'kypo-archived-adaptive-run-overview',
  templateUrl: './archived-adaptive-run-overview.component.html',
  styleUrls: ['./archived-adaptive-run-overview.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ArchivedAdaptiveRunOverviewComponent extends SentinelBaseDirective {
