/*
 * Public API Surface of entry point kypo-training-agenda/adaptive-run-detail
 */

export * from './components/adaptive-run-detail-components.module';
export * from './components/adaptive-run-detail-game.module';
