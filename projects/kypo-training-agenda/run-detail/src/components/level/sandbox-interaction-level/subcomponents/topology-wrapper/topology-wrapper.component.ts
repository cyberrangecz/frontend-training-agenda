...
import { KypoTopologyErrorService, KypoTopologyGraphModule } from '@muni-kypo-crp/topology-graph';
...
@Component({
  ...
  standalone: true,
  imports: [AsyncPipe, KypoTopologyGraphModule, MatButton, MatTooltip],
