...
describe('ArchivedTrainingRunOverviewComponent', () => {
    ...
    TestBed.configureTestingModule({
      ...
      imports: [
        ...
        RouterTestingModule.withRoutes([
          { path: 'training-run/1/results', component: ArchivedTrainingRunOverviewComponent },
        ]),
        Kypo2TableModule,
      ],
      providers: [{ provide: ArchivedTrainingRunService, useValue: archivedTrainingRunServiceSpy }],
    }).compileComponents();
  ...
  it('should add row to selected rows array', () => {
    component.onRowSelection([new TrainingRunRowAdapter(createMockRun('1'))]);
