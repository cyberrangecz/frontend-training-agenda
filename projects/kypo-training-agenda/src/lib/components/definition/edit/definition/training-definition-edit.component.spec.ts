...
import { TrainingDefinitionChangeEvent } from 'projects/kypo-training-agenda/src/lib/model/events/training-definition-change-event';
...
describe('TrainingDefinitionEditComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      imports: [TrainingDefinitionEditOverviewMaterialModule, FreeFormModule],
